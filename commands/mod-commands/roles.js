...
exports.run = async (client, message, args) => {
    ...
    const a = message.guild.roles.get('551408119062986753'); // announcement
    const b = message.guild.roles.get('542053413932761119'); // changelogs
    const c = message.guild.roles.get('542053430227632130'); // gaming
